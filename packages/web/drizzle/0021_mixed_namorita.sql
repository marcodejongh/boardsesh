...
--> statement-breakpoint
ALTER TABLE "board_sessions" ADD COLUMN "status" text DEFAULT 'active' NOT NULL;--> statement-breakpoint
...
CREATE INDEX "playlists_uuid_idx" ON "playlists" USING btree ("uuid");--> statement-breakpoint
CREATE INDEX "playlists_updated_at_idx" ON "playlists" USING btree ("updated_at");--> statement-breakpoint
CREATE INDEX "board_sessions_status_idx" ON "board_sessions" USING btree ("status");--> statement-breakpoint
CREATE INDEX "board_sessions_last_activity_idx" ON "board_sessions" USING btree ("last_activity");--> statement-breakpoint
CREATE INDEX "board_sessions_discovery_idx" ON "board_sessions" USING btree ("discoverable","status","last_activity");