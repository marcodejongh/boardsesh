/**
 * Static board configuration data.
 * This mirrors the web package's board-data.ts but is self-contained for the backend.
 */

import type { BoardName, Angle } from './types.js';
