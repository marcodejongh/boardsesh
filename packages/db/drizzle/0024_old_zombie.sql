...
CREATE UNIQUE INDEX IF NOT EXISTS "boardsesh_ticks_aurora_id_unique" ON "boardsesh_ticks" USING btree ("aurora_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "playlists_aurora_id_idx" ON "playlists" USING btree ("aurora_id");--> statement-breakpoint
