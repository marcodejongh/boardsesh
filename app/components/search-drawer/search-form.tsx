...
import { Form, Slider, InputNumber, Select, Input, Switch, Alert } from 'antd';
...
const SearchForm: React.FC<SearchFormProps> = () => {
      ...
      return (
        <Form.Item>
          <Alert
            ...
            description="Login to your account to search for your favour climbs, climbs you've done, or attempted."
            type="info"
            showIcon
          />
        </Form.Item>
  ...
  return (
    // TODO Use different widths on diff devices
